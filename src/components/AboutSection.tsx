    ...
    <div id="about-section-container" className="space-y-16 pb-16 font-sans">
      ...
      <section className="bg-emerald-950 text-white py-12 border-b-4 border-amber-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl font-bold">15 Years of Milling Purity</h1>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <span className="text-xs text-emerald-800 font-bold uppercase tracking-wider flex items-center">
              ...
              <span>Est. 2011 • Kallakurichi</span>
            </span>
          ...
          <p className="text-stone-600 text-sm leading-relaxed font-sans">
            Founded in 2011 in Kallakurichi, Sri Kannika Parameswari Modern Rice Mill began with a singular focus: to offer South Indian families clean, unadulterated Ponni rice of outstanding grade. At a time when traditional milling relied on unhygienic open drying fields and manual grading, we pioneered modern closed-loop mechanical pre-cleaning.
          </p>
          <p className="text-stone-600 text-sm leading-relaxed font-sans">
