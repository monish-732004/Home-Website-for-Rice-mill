...
import GrainSimulator from './GrainSimulator';
...
export default function HomeSection({ onNavigate, onSelectProduct, openDealerModal }: HomeSectionProps) {
  // Slices first 3 products for homepage preview
  const featuredProducts = PRODUCTS.filter(p => p.isPopular).slice(0, 3);

  const stats = [
    { value: '30+ Years', label: 'Milling Legacy', desc: 'Established in 1992 in Kallakurichi' },
  ...
  return (
    <div id="home-section-container" className="space-y-20 pb-16">
      ...
      >
        ...
        <div className="w-full lg:w-3/5 p-6 sm:p-12 lg:p-16 flex flex-col justify-center bg-stone-50 relative z-10 overflow-hidden">
          ...
          <div className="mb-6 z-10">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] bg-emerald-800 text-stone-50 px-3.5 py-1.5 rounded-sm italic">
              Since 1992 • Kallakurichi
            </span>
          </div>
          
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.1] font-light mb-6 text-stone-900 z-10">
            {APP_INFO.taglineEn}<br/>
            <span className="italic font-normal text-amber-500 text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2 block">{APP_INFO.taglineTa}</span>
          </h1>
          
          <p className="text-sm sm:text-base md:text-lg max-w-xl text-stone-700 leading-relaxed mb-8 font-light z-10">
            Celebrating decades of agricultural heritage. Our modern rice mill in Kallakurichi blends Tamil farming traditions with cutting-edge optical sorting technology to deliver the finest, fluffiest Ponni to your table.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-6 sm:gap-10 mt-10 pt-8 border-t border-stone-200/80 z-10">
            <div>
              <div className="text-xl sm:text-2xl font-serif text-emerald-800 font-bold">1992</div>
        ...
        <div className="w-full lg:w-2/5 relative bg-emerald-900 p-8 sm:p-12 lg:p-16 flex flex-col justify-between overflow-hidden min-h-[380px] lg:min-h-auto text-left">
          ...
          <div className="absolute inset-0 z-0">
            <img
              src="https://images.unsplash.com/photo-1523539693385-e5e891eb4465?q=80&w=689&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Delta Fields Pattern"
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="space-y-2">
            <span className="text-xs text-emerald-800 font-bold uppercase tracking-wider flex items-center">
              ...
              <span>Sustaining 30+ Years of trust</span>
            </span>
          ...
          <p className="text-stone-600 text-sm leading-relaxed font-sans">
            Our history is intertwined with Tamil Nadu's agricultural heartlands, sourcing premium paddy to ensure exceptional sweetness and mineral density. At Sri Kannika Parameswari, we treat grain processing as a fine craft. 
          </p>
          <p className="text-stone-600 text-sm leading-relaxed font-sans">
      ...
      {/* Interactive Grain Cooking Sandbox Section */}
      <section id="home-grain-sandbox" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <GrainSimulator />
      </section>
