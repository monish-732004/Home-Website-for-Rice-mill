...
export default function ContactSection() {
  const supportChannels = [
    ...
    },
    {
      ...
      phone: '+91 94422 84994',
      email: 'srikannika.ricemill@gmail.com',
      desc: 'Get live updates on dispatch tracking, shipping consignments, container stuffing, or bulk packaging schedules.'
    },
    {
            ...
            <div className="p-5 bg-white border border-stone-200/80 rounded-2xl shadow-sm space-y-3">
              ...
              <div className="border-t border-stone-100 pt-3 flex items-start space-x-3 text-sm">
                ...
                <div className="text-stone-700 text-xs">
                  ...
                  <p className="text-stone-400 text-[10px] italic mt-1">* Closed on Sundays for weekly hygiene & machinery cleaning maintenance.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="space-y-1">
              <h3 className="font-serif font-bold text-lg text-stone-900 flex items-center">
                ...
                <span>Delta Facility Location Directions</span>
              </h3>
              <p className="text-xs text-stone-500">Located on the central Thanjavur highway for rapid truck transit routes.</p>
            </div>
            <a
