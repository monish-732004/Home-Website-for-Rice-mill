            ...
            >
              ...
              <div className="w-full lg:w-1/2 space-y-4">
                <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm relative overflow-hidden group">
                  <div className="absolute top-0 right-0 bg-stone-50 border-l border-b border-stone-200/60 py-1.5 px-3.5 rounded-bl-xl text-stone-400 font-mono font-bold text-xs">
                    STEP 0{step.stepNumber}
                  </div>
                  <div className="flex items-center space-x-3.5 mb-5">
                    <div className="w-12 h-12 bg-emerald-50 text-emerald-800 rounded-xl flex items-center justify-center shadow-sm">
                      {stepIcon}
                    </div>
                    <div>
